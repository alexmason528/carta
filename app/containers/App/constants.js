...
export const GET_WISHLIST_REQUEST = 'carta/App/GET_WISHLIST_REQUEST'
export const GET_WISHLIST_SUCCESS = 'carta/App/GET_WISHLIST_SUCCESS'
export const GET_WISHLIST_FAIL = 'carta/App/GET_WISHLIST_FAIL'

export const CREATE_WISHLIST_REQUEST = 'carta/App/CREATE_WISHLIST_REQUEST'
export const CREATE_WISHLIST_SUCCESS = 'carta/App/CREATE_WISHLIST_SUCCESS'
export const CREATE_WISHLIST_FAIL = 'carta/App/CREATE_WISHLIST_FAIL'

export const DELETE_WISHLIST_REQUEST = 'carta/App/DELETE_WISHLIST_REQUEST'
export const DELETE_WISHLIST_SUCCESS = 'carta/App/DELETE_WISHLIST_SUCCESS'
export const DELETE_WISHLIST_FAIL = 'carta/App/DELETE_WISHLIST_FAIL'
